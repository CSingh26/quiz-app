...
import { useInstructorAuth } from "@/app/components/loginPage/instructor/Functions/AuthFunctions"
import LoginForm from "@/app/components/loginPage/instructor/Auth/LoginForm"
import { motion } from "framer-motion"

export default function InstructorLogin() {
  const { handleLogin } = useInstructorAuth()

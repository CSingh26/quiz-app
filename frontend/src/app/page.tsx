  ...
  return (
    <div className="min-h-screen bg-[#3c6ca8] text-white flex flex-col items-center">
      ...
      <div className="text-center mt-6">
        <h1 className="text-5xl font-bold mb-2">QuizBee</h1>
        <p className="text-2xl font-semibold">Quiz Smarter, Learn Faster</p>
      </div>
      ...
      {/* Pink Box */}
      <div className="w-full bg-[#eab2bb] rounded-3xl py-10 px-6 shadow-md mt-4">
